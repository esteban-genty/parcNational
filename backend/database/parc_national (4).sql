...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 30 sep. 2025 à 20:45
...
INSERT INTO `camping` (`id`, `nom`, `localisation`, `capacite`) VALUES
(24, 'Camping du Cap', 'Calanque de Sormiou', 50),
(25, 'Camping du Cap', 'Calanque de Sormiou', 50),
(26, 'Camping du Cap', 'Calanque de Sormiou', 50);
...
INSERT INTO `reservation` (`id`, `visiteur_id`, `camping_id`, `date_debut`, `date_fin`) VALUES
(15, 1, 1, '2025-10-10', '2025-10-12');
...
INSERT INTO `sentier` (`id`, `nom`, `difficulte`, `description`) VALUES
(14, 'Sentier du Pic', 'difficile', 'Montée raide.');
...
(4, 'oussama', 'halimafilalio@gmail.com', '$2y$10$PM9nTA8aLbTmbnJaO1p/YepB6vJNh9MFK2rHEVriDi6NXd5qca9i.', 'visiteur'),
(5, 'Admin', 'admin@parcnational.fr', '$2y$10$QJwQwQwQwQwQwQwQwQwQwOQwQwQwQwQwQwQwQwQwQwQwQwQwQwQwQwQwQwQwQwQw', 'admin');
