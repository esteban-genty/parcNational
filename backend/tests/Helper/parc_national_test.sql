-- Script de création de la base de test pour le Parc National des Calanques
-- Version adaptée pour PHPUnit
...
CREATE DATABASE IF NOT EXISTS `parc_national_test` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `parc_national_test`;

-- Désactiver les vérifications de clés étrangères pour permettre la recréation des tables
